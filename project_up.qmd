...
1. Security Incidents Dataset (1997-2024)
   - Source: Provided course dataset
   - Filename: `security_incidents.csv`
   - Scope: Humanitarian worker security incidents
   - Time Period: 1997-2024
   - Content: Comprehensive record of incidents affecting humanitarian staff

**Note:** This dataset was the primary source for all analyses in this research project. No additional external sources were consulted beyond the provided CSV file.
